	...
	<main>
		...
		<h2>会員情報登録</h2>
			...
			<form action="register-member" method="post">
				...
				<p>
					ユーザーID<input type="text" name="member_id" pattern="[A-Za-z0-9]+"
						required>半角英数字
				</p>
				<p>
					パスワード<input type="password" name="password" required>半角英数字
				</p>
				<p>
				...
				<p>
					メールアドレス<input type="mail" name="mail_address" required>
				</p>
