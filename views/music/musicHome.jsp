...
<link rel = "stylesheet" href = "<c:url value = '/css/musicHome.css' />">
</head>
<body>
...
<main>
	...
	<!-- 検索バー -->
	<form id = "searchForm" action = "<c:url value='/views/music/searchForm' />" method = "get">
...
<!--	</div>-->
	...
	<section>
		<h2>Popular Songs</h2>
		<ol class = "music-list">
			<c:forEach var = "music" items = "${popularMusicList }" varStatus="status">
				<li class = "music-card">
